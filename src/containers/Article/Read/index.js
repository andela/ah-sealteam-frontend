...
import { getRatings } from '../../../actions/ratings.actions';
var average_url =
...
class Read extends Component {
    componentWillMount() {
        ...
        let average_url = `https://ah-sealteam-staging.herokuapp.com/api/articles/${slug}/rate?rate=average`;
        this.props.dispatch(getRatings(average_url));
    }
    ...
    render() {
        ...
        const { average_ratings } = this.props.ratings;
